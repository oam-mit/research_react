...
import { showErrorAlert, showNetworkError, showSuccessAlert, yesNoAlert } from "../../services/AlertService";
...
export type ContextType ={
    ...
    change_applicant_status:(applicant:ApplicantType,status:string,status_show:string)=>void
}
...
class ApplicationsProvider extends Component<PropsType,ContextType>
{
    ...
    change_application_status=(applicant:ApplicantType,status:string,status_show:string)=>
    {
        yesNoAlert(
        'Confirmation', 
