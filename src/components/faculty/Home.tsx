		...
		return (
			<>
				...
				>
					...
					<button
						onClick={() => this.props.history.push("/faculty/project/add")}
									...
									<div className="row text-center">
										<div className="col-12">
											<h2
												...
												onClick={() =>
													this.toggle_show_variable("active_projects_shown")
												}
												style={{ cursor: "pointer" }}
											>
												Active Projects{" "}
												{this.render_arrow(this.state.active_projects_shown)}
											</h2>
										</div>
									</div>
									...
									<div className="row text-center">
										<div className="col-12">
											<h2
												className="sub-heading-faculty"
												onClick={() =>
													this.toggle_show_variable("past_projects_shown")
												}
												style={{ cursor: "pointer" }}
											>
												Past Projects{" "}
												{this.render_arrow(this.state.past_projects_shown)}
											</h2>
										</div>
									</div>
									<div className="row">
