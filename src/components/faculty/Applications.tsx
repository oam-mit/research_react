...
import { ApplicationsContext, ContextType } from '../../backend/faculty/ApplicationsProvider';
...
const Applications=()=>{
    ...
    return(
            ...
            <div className="jumbotron jumbotron-fluid text-white text-center my-3" id="jumbo-color">
                <h3 className="display-1" id="jumbo-text">Pending Applicantions</h3>
                <button onClick={()=>history.push(`/faculty/applications/accepted/${params.project_uuid}`)} className="btn-mystyle"><h5>View Accepted Applicants</h5></button>
            </div>
