...
import { AcceptedApplicationsContext, ContextType } from '../../backend/faculty/AcceptedApplicationsProvider';
...
const AcceptedApplications= ()=>
{
                     ...
                     <table className="table table-bordered table-style table-scroll">
                        ...
                        <tbody>
                            {state.applications.map((applicant)=>{
                                return(
                                    <AcceptedApplicationCard applicant={applicant}/>
                                );
                            })}
                        </tbody>
                     </table>
    ...
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-white text-center my-3" id="jumbo-color">
            ...
            <button onClick={()=>history.push(`/faculty/applications/${params.project_uuid}`)} className="btn-mystyle"><h5>View Applicants</h5></button>
        </div>
