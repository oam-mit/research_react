...
import {anime,DOM} from 'animejs/lib/anime.js';
...
export class Details {
    constructor() {
        ...
        <div class="details__bg details__bg--down">
            <button class="details__close"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
