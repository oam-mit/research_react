...
import { DepartmentType, HomeContext } from '../../backend/student/HomeProvider';
...
const Home = ()=>{
    ...
    return(
        ...
        <div className="container-fluid">
            <div className="row">
                {!state.loading ? render_departments(state.departments) : <Spinner size={50} position={'relative'}/> }
