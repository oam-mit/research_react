      ...
      return (
          <>
            {this.state.showNavbar && <Navbar/>}
              <Switch>
                <Route path="/student/home" render={
                  ()=>
                  <HomeProvider>
                    <Home />
                  </HomeProvider>}/>
                ...
                <Route path="/student/department/:department_slug" render={
                  ()=>
                <DepartmentProvider>
                  <Department /> 
                </DepartmentProvider>}/>

                <Route path="/student/:department_slug/project/:uuid_field" render={
                  ()=>
                  <ProjectProvider toggleNavbar={(value:boolean)=>{this.toggleNavbar(value)}}>
                    <ProjectRoot />
                  </ProjectProvider>
                }/>

                <Route path="/student/applications" render={
                  ()=> 
                  <ApplicationProvider>
                    <Applications />
                  </ApplicationProvider>  
                ...
                <Route path="/student/not-found" render={
                  ()=>
                  <NotFound/>
                  }/>
              </Switch>
