...
class ProjectRoot extends Component<IProps,StateType>
{
    ...
    {
        this.props.history.replace(`/student/department/${this.props.match.params.department_slug}`);
    }
        ...
        return(
            <ProjectContext.Consumer>
                ...
                <SideNav 
                    ...
                    select_project={(project_uuid_field:string)=>this.select_project(project_uuid_field,props)}
                />
                <Project 
