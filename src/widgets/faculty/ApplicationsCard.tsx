...
type PropsType={
    ...
    change_application_status:(applicant:ApplicantType,status:string,status_show:string)=>void
}

const ApplicationCard = ({applicant,change_application_status}:PropsType)=>{
    return(
        <tr >
            ...
            <div className="dropdown show">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <button onClick={()=>change_application_status(applicant,ACCEPTED,'accept')}  className="dropdown-item" >Accept</button>
                    <button onClick={()=>change_application_status(applicant,REJECTED,'reject')} className="dropdown-item" >Reject</button>
                </div>
            </div>
            </th>
        </tr>
