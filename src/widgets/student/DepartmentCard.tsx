...
const DepartmentCard = ({project,department_slug}:{project:ProjectType,department_slug:string|null})=> {
    
    let history=useHistory();

    const navigateToProject = (event:React.MouseEvent<HTMLDivElement, MouseEvent>)=>{
    ...
    return(
        <Fade bottom>
            <div className="col-lg-3" style={{cursor:'pointer'}} onClick={(event)=>{
